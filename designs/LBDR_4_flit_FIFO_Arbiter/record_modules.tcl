vcd files $RESULTS_FOLDER/fifo.vcd $RESULTS_FOLDER/fifoc.vcd $RESULTS_FOLDER/fifod.vcd $RESULTS_FOLDER/lbdr.vcd $RESULTS_FOLDER/arbiter.vcd $RESULTS_FOLDER/xbar.vcd
