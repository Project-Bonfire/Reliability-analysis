...
class MyTest(unittest.TestCase):
    ...
    def testGetModulesNone(self):#7325 1675 0 10 \FIFO_W/FIFO_comb/U208 :A2 FIFO_W/FIFO_comb/n384 [('FIFO_W/FIFO_comb/U209/Q', 'Output Pin(INVXL)')]
        res = Result()
        res.params = '8173 2827 0 10 \FIFO_L/FIFO_comb/U116 :B2 !none'
        self.assertEqual(res.getFaultModuleFromParam(),None)

    def testGetModulesNofault(self):#7325 1675 0 10 \FIFO_W/FIFO_comb/U208 :A2 FIFO_W/FIFO_comb/n384 [('FIFO_W/FIFO_comb/U209/Q', 'Output Pin(INVXL)')]
        res = Result()
