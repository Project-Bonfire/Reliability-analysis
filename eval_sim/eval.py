...
dirname = "../results/2017-09-30.18:17:24/"
...
print('Total number of unexpected length of sent packets: %d' % sum(uls))
print('Total number of unexpected length of recv packets: %d' % sum(ulr))
